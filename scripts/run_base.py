...
from filtering.SteerableFilter.execute_steerable_filter import execute_steerable_filter
from filtering.AdaptiveIIR.execute_adaptive_iir_filter import execute_adaptive_filter
...
def execute_pipeline_steerable(data_file, output_dir, filts_config, params, crop_bounds=None):
    return execute_steerable_filter(data_file, output_dir, filts_config, params, crop_bounds)

def execute_pipeline_adaptive(data_file, output_dir, filts_config, params, crop_bounds=None):
    return execute_adaptive_filter(data_file, output_dir, filts_config, params, crop_bounds)
